...
const insertSnippets = [
  ...
  { label: 'Fracción', value: String.raw`\frac{a}{b}` },
  { label: 'Raíz cuadrada', value: String.raw`\sqrt{x^2 + y^2}` },
  { label: 'Valor absoluto', value: String.raw`|x - 3| = 5` },
  { label: 'Potencia', value: String.raw`x^n + y^n = z^n` },
  { label: 'Pitágoras', value: String.raw`a^2 + b^2 = c^2` },
  { label: 'Segundo grado', value: String.raw`x^2 + bx + c = 0` },
  { label: 'Fórmula general', value: String.raw`x = \frac{-b \pm \sqrt{b^2 - 4ac}}{2a}` },
  ...
  { label: 'Límite', value: String.raw`\lim_{x \to 0} \frac{\sin x}{x} = 1` },
  ...
  <section class="editor-card">
    <div class="editor-toolbar">
      <div>
        ...
        <div class="status-text">
          El MathML se renderiza a la derecha y cada línea del textarea se
          procesa como una ecuación independiente.
        </div>
      </div>
    ...
    <div class="row g-4">
      <div class="col-md-6">
        ...
        <textarea
          ...
          rows="20"
          spellcheck="false"
          placeholder="Escribe aquí tu fórmula o bloque LaTeX"
        />
      </div>
      ...
      <div class="col-md-6">
        ...
        <div class="mathml-panel">
          ...
          <template v-else-if="mathMlOutput.length">
            ...
            >
              {{ showMathMlCode ? 'Ocultar código HTML' : 'Ver código HTML' }}
            </button>
          ...
          <p v-else class="placeholder-copy">
            El MathML aparecerá aquí cuando haya contenido válido.
          </p>
        </div>
      </div>
    </div>
